...
from pypresence.exceptions import DiscordNotFound, InvalidArgument, InvalidPipe, PipeClosed, ResponseTimeout, ServerError
...
def test_rpc_update_success():
    with patch('packet_tracer_presence.rpc_manager.Presence'):
        ...
        rpc.update(project_name='NetworkLab.pkt', is_unsaved=False, start_time=1000, file_type='pkt', active_device='Router0', device_type='router', activity_timer='01:20:00')
        rpc.presence.update.assert_called_once_with(buttons=PRESENCE_BUTTONS, details=f'Building network {MIDDOT} NetworkLab.pkt', state='Provisioning Router0', start=1000, large_image='packet_tracer', large_text=f'Cisco Packet Tracer {MIDDOT} Realtime mode {MIDDOT} Logical view', small_image='cisco', small_text=f'Router0 {MIDDOT} Cisco router')
...
def test_rpc_update_unsaved_state():
    with patch('packet_tracer_presence.rpc_manager.Presence'):
        ...
        rpc.connected = True
        rpc._last_update_time = 0.0
        rpc.update(project_name='Topology.pkt', is_unsaved=True, start_time=1000, file_type='pkt', active_device=None, device_type='pt_logo', activity_timer=None)
        rpc.presence.update.assert_called_once_with(buttons=PRESENCE_BUTTONS, details='Architecting a new network', state='Designing the network topology', start=1000, large_image='packet_tracer', large_text=f'Cisco Packet Tracer {MIDDOT} Realtime mode {MIDDOT} Logical view', small_image='cisco', small_text='Cisco Systems')
...
def test_rpc_update_active_sub_app():
    with patch('packet_tracer_presence.rpc_manager.Presence'):
        ...
        rpc.connected = True
        rpc._last_update_time = 0.0
        rpc.update(project_name='LAB1.3 CLI config.pka', is_unsaved=False, start_time=1000, file_type='pka', active_device='Laptop0', active_sub_app='Terminal (Switch#)', device_type='laptop', completion_percent='75%')
        rpc.presence.update.assert_called_once_with(buttons=PRESENCE_BUTTONS, details=f'Certification lab {MIDDOT} 75% solved', state=f'Laptop0 {MIDDOT} Terminal (Switch#)', start=1000, large_image='packet_tracer', large_text=f"Cisco Packet Tracer {MIDDOT} {_progress_bar('75%')} 75%", small_image='cisco', small_text=f'Laptop0 {MIDDOT} Cisco laptop')
...
def test_rpc_update_pka_completion_and_timer():
    with patch('packet_tracer_presence.rpc_manager.Presence'):
        ...
        rpc.connected = True
        rpc._last_update_time = 0.0
        rpc.update(project_name='CCNA1_Lab.pka', is_unsaved=False, start_time=1000, file_type='pka', active_device='PC0', active_sub_app='Command Prompt', device_type='pc', completion_percent='75%', activity_timer='00:34:32')
        rpc.presence.update.assert_called_once_with(buttons=PRESENCE_BUTTONS, details=f'Certification lab {MIDDOT} 75% solved', state=f'PC0 {MIDDOT} Command Prompt', start=1000, large_image='packet_tracer', large_text=f"Cisco Packet Tracer {MIDDOT} {_progress_bar('75%')} 75%", small_image='cisco', small_text=f'PC0 {MIDDOT} Cisco pc')
...
def test_rpc_update_workspace_canvas_tools():
    with patch('packet_tracer_presence.rpc_manager.Presence'):
        ...
        rpc.connected = True
        rpc._last_update_time = 0.0
        rpc.update(project_name='Campus.pkt', is_unsaved=False, start_time=1000, file_type='pkt', active_device=None, workspace_tool='Testing Connectivity (Simple PDU Ping)')
        rpc.presence.update.assert_called_once_with(buttons=PRESENCE_BUTTONS, details=f'Building network {MIDDOT} Campus.pkt', state='Using Testing Connectivity (Simple PDU Ping)', start=1000, large_image='packet_tracer', large_text=f'Cisco Packet Tracer {MIDDOT} Realtime mode {MIDDOT} Logical view', small_image='cisco', small_text='Cisco Systems')
...
def test_rpc_update_pka_no_completion_simulation():
    with patch('packet_tracer_presence.rpc_manager.Presence'):
        ...
        rpc.connected = True
        rpc._last_update_time = 0.0
        rpc.update(project_name='Activity.pka', is_unsaved=False, start_time=1000, file_type='pka', active_device=None, sim_mode='Simulation', view_mode='Physical')
        rpc.presence.update.assert_called_once_with(buttons=PRESENCE_BUTTONS, details=f'Certification lab {MIDDOT} Activity.pka', state='Tracing packets hop-by-hop', start=1000, large_image='packet_tracer', large_text=f'Cisco Packet Tracer {MIDDOT} Simulation mode {MIDDOT} Physical view', small_image='cisco', small_text='Cisco Systems')
...
@pytest.mark.parametrize('sub_app,expected_state', [('CLI', 'Live IOS console on Router0'), ('cli', 'Live IOS console on Router0'), ('Config', 'Configuring interfaces on Router0'), ('CONFIG', 'Configuring interfaces on Router0'), ('Desktop', 'Running diagnostics from Router0'), ('desktop', 'Running diagnostics from Router0')])
def test_rpc_update_state_sub_app_variants(sub_app, expected_state):
    with patch('packet_tracer_presence.rpc_manager.Presence'):
        ...
        rpc.connected = True
        rpc._last_update_time = 0.0
        rpc.update(project_name='NetworkLab.pkt', is_unsaved=False, start_time=1000, file_type='pkt', active_device='Router0', active_sub_app=sub_app)
...
def test_rpc_update_state_device_no_sub_app_is_provisioning():
    with patch('packet_tracer_presence.rpc_manager.Presence'):
        ...
        rpc.connected = True
        rpc._last_update_time = 0.0
        rpc.update(project_name='NetworkLab.pkt', is_unsaved=False, start_time=1000, file_type='pkt', active_device='Switch1', active_sub_app=None)
...
def test_rpc_update_small_text_missing_device_type():
    with patch('packet_tracer_presence.rpc_manager.Presence'):
        ...
        rpc.connected = True
        rpc._last_update_time = 0.0
        rpc.update(project_name='NetworkLab.pkt', is_unsaved=False, start_time=1000, file_type='pkt', active_device='Blade0', device_type='pt_logo')
...
def test_rpc_update_state_deduplication():
    with patch('packet_tracer_presence.rpc_manager.Presence'):
        ...
        rpc.connected = True
        rpc._last_update_time = 0.0
        state = {'project_name': 'NetworkLab.pkt', 'is_unsaved': False, 'file_type': 'unknown', 'active_device': None, 'active_sub_app': None, 'device_type': 'pt_logo', 'activity_timer': None, 'completion_percent': None, 'sim_mode': 'Realtime', 'view_mode': 'Logical', 'workspace_tool': None}
...
def test_progress_bar_clamps_out_of_range(value, expected_filled):
    ...
    assert bar.count(chr(9608)) == expected_filled
...
@pytest.mark.parametrize('transport_error', [ServerError('discord hiccup'), ResponseTimeout(), InvalidPipe(), AssertionError()])
...
def test_rpc_connect_timeout_rebuilds_presence():
    with patch('packet_tracer_presence.rpc_manager.Presence'):
        ...
        stale = MagicMock()
        rpc.presence = stale
        with patch('packet_tracer_presence.rpc_manager._call_with_timeout', side_effect=TimeoutError('timed out')):
            assert rpc.connect() is False
...
def test_rpc_connect_unexpected_error_is_logged_not_swallowed(caplog):
    with patch('packet_tracer_presence.rpc_manager.Presence'):
        ...
        stale = MagicMock()
        rpc.presence = stale
        with patch('packet_tracer_presence.rpc_manager._call_with_timeout', side_effect=RuntimeError('This event loop is already running')):
...
def test_rpc_update_pka_completion_renders_bar():
    with patch('packet_tracer_presence.rpc_manager.Presence'):
        ...
        rpc.connected = True
        rpc._last_update_time = 0.0
        rpc.update(project_name='Activity.pka', is_unsaved=False, start_time=1000, file_type='pka', completion_percent='50%')
        large_text = rpc.presence.update.call_args.kwargs['large_text']
        assert chr(9608) * 5 + chr(9617) * 5 in large_text
...
def test_rpc_update_unknown_device_type_falls_back_to_default_asset():
    with patch('packet_tracer_presence.rpc_manager.Presence'):
        ...
        rpc.connected = True
        rpc._last_update_time = 0.0
        rpc.update(project_name='NetworkLab.pkt', is_unsaved=False, start_time=1000, file_type='pkt', active_device='Blade0', device_type='not_a_real_device')
