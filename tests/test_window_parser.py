...
class TestWindowParser(unittest.TestCase):
    ...
    def setUp(self):
        ...
        WindowParser._uia_disabled = False
    ...
    @patch('pygetwindow.getAllWindows', return_value=[])
    @patch('packet_tracer_presence.window_parser.WindowParser._get_pt_pids', return_value={-1})
    def test_uia_root_scan_uses_real_library(self, mock_pids, mock_windows):
        self.parser.get_active_activity()
        self.assertFalse(WindowParser._uia_disabled)
    ...
    def test_workspace_canvas_tools_uia(self, mock_pids, mock_active, mock_auto):
        ...
        mock_win_ctrl.ProcessId = 1234
        mock_win_ctrl.ControlTypeName = 'WindowControl'
    ...
    def test_device_terminal_cli_mode_uia(self, mock_pids, mock_active, mock_auto):
        ...
        mock_dev_ctrl.ProcessId = 1234
        mock_dev_ctrl.ControlTypeName = 'WindowControl'
